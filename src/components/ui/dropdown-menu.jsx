...
DropdownMenuItem.propTypes = { className: PropTypes.string, inset: PropTypes.bool, variant: PropTypes.string };
DropdownMenuCheckboxItem.propTypes = { className: PropTypes.string, children: PropTypes.node, checked: PropTypes.bool };
